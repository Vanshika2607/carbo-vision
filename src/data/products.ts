...
'Mobile App':	'Health data dashboard, alerts, battery status, live location'
  ...
  },
  {
    ...
    description: 'Convert Your Home Into Smart Home/Office. (15000/- for 3 plugs)',
    features: [
...
'Energy Monitoring': 'Real-time power usage tracking'
    ...
    images: [
      'https://i.postimg.cc/X7SPT6sG/Whats-App-Image-2026-02-17-at-5-03-54-PM.jpg',
      'https://i.postimg.cc/Px07XgTj/Whats-App-Image-2026-02-19-at-11-05-04-AM.jpg'
    ],
    description: 'Want To Ride Eco-friendly .. Give it a go',
    features: [
      'Real time data collection system',
      'Utilize GIS data for crop selection',
      'Develop AI model to analyze sensor data for fertilizer recommendation',
      'AI based crop disease detection system',
      'Optimize resource utilization',
      'Implement farmer friendly web interface',
      'Easy Maintenance'
    ],
    specifications: {
